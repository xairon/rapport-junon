...
\paragraph{Supervision scientifique — Nicolas Labroche (LIFAT).} Responsable du volet PREDICTION
du programme, il a encadré l'orientation scientifique des travaux, en particulier l'arbitrage
...
car elle a produit des effets identifiables dans le code~\cite{reunion_cadrage}.
...
cohérence temporelle sont mis en œuvre par la méthode contrefactuelle de la
...
chapitre~\ref{ch:observatoire} — un indicateur réellement standardisé ou une valeur réelle,
...
calcul et les bases sur un serveur équipé d'un processeur graphique — et son usage demeure à ce
...
le rapprochement avec les modèles à réservoirs du BRGM et l'accès à leurs travaux de comparaison
de modèles. L'élargissement des usages au-delà du cercle projet suppose une politique d'accès et
un accompagnement, davantage que des développements supplémentaires.
\end{acquisouvert}
