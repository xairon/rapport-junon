...
suppose un seuillage, donc une norme implicite — et cette norme, n'étant pas une référence
...
\begin{limite}[title={Une leçon d'architecture}]
Une protection configurée dans un composant qui ne tourne pas est une protection absente, avec
en plus la croyance qu'elle existe. La consolidation en un point d'entrée unique vaut moins pour
sa simplicité que pour la disparition de cet écart.
\end{limite}
