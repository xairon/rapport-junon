...
Volume & environ \num{7000} lignes Python et \num{1200} lignes SQL de transformation \\
Ingestion & bibliothèque déclarative : pagination, reprise sur erreur, déduplication par
fusion, partitionnement annuel de 1967 à aujourd'hui \\
...
volumes déclarés hors du cycle de vie des conteneurs \\
\bottomrule
\end{tabularx}
\end{center}
...
de débit \\
C\oe ur métier & bibliothèque Python sans dépendance d'interface : préparation, modèles métier,
...
de l'ouverture et de l'exploitation de chaque ouvrage.

\begin{remarque}[title={Mentions obligatoires}]
...
ETP et ET0 & évapotranspiration potentielle ; évapotranspiration de référence au sens de la
FAO-56 \\
