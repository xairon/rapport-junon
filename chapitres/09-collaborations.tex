...
Le code des deux dépôts est publié sous licence MIT, qui n'impose ni réciprocité ni
autorisation préalable à la reprise. Les dépôts eux-mêmes sont hébergés sur la forge de
l'université et restent accessibles sur demande, ce qui n'est pas la même chose qu'un dépôt
public : la licence autorise la réutilisation, l'hébergement ne la rend pas encore immédiate.
