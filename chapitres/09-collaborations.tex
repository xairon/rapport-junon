...
Deux dépôts complémentaires portent les travaux personnels décrits en
section~\ref{sec:travaux-perso}. Ils sont publiés séparément, sous licence Apache 2.0, dont la
concession de brevet explicite convient à des méthodes originales :

\begin{itemize}
  \item le prototype de contrefactuels sous contrainte physique :\\
        \url{\urlphyscf}
  \item le banc d'essai des représentations de chroniques :\\
        \url{\urlbanc}
\end{itemize}

\noindent
Ils ne sont pas nécessaires à la reprise du socle, qui n'en dépend pas. Le premier documente
l'origine d'une méthode que la bibliothèque métier intègre ; le second porte un résultat qui
conditionne l'interprétation des modèles multivariés.
