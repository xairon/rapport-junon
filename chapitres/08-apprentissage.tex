...
une autre forge. Parmi les cinq cas non passants, deux exigent un entrepôt peuplé et relèvent
en réalité de l'intégration, un lit un fichier absent de tout autre poste, un est mis en défaut
par la base en mémoire employée pour les tests, qui ne conserve pas le fuseau horaire, et le
dernier est ignoré. Aucun ne
...
l'application. Il faut le prendre pour ce qu'il est : un banc d'expérimentation prêt à servir,
et non une étude de performances. Aucune architecture n'est ici recommandée plutôt qu'une autre,
et ce silence est volontaire.

Deux chantiers restent ouverts, de natures différentes. L'évaluation comparative des
architectures relève de la recherche et revient à ceux qui reprendront ces travaux.
L'automatisation de la suite de tests relève de l'ingénierie et devrait être traitée en premier,
car elle conditionne la confiance dans toutes les évolutions ultérieures.
