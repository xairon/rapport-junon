...
\paragraph{Des indicateurs de sécheresse produits à l'échelle nationale, et vérifiés.} Ils
situent chaque mois par rapport à la normale de saison, de la même manière sur tout le
territoire. Leur mise en œuvre a demandé deux arbitrages qui ne vont pas de soi : identifier
parmi les variables climatiques disponibles celle qui correspond réellement à la grandeur
attendue, et retenir la formulation statistique qui couvre l'ensemble des régions françaises.
Ni l'un ni l'autre ne relève de la correction d'une erreur : ce sont des choix de mise en œuvre,
dont le chapitre~\ref{ch:indicateurs} montre qu'ils décident de la justesse du résultat. Leur
conformité a été vérifiée sur près de \num{42} millions de valeurs, contre un critère fixé avant
la mesure.
