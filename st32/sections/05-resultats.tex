...
Le tableau~\ref{tab:etat-qr} récapitule ce que le socle apporte à chaque question et ce qui manque encore. La colonne d'état est délibérément sévère : \emph{outillé} signifie que les moyens existent, pas qu'un résultat a été produit.
...
le plan variable-temps & outillé, non évalué \\
QR2 & Deux méthodes contrefactuelles de natures différentes, test de cohérence croisée contre
un modèle indépendant, protocole de comparaison formalisé & outillé, non mesuré \\
\bottomrule
\end{tabularx}
\end{table}
